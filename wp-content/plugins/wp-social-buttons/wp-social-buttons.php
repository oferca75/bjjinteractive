...
<!-- Start Options Form -->
	...
	<p><label><strong><?php _e('Publish Buttons:');?></strong></label>&nbsp;<input type="checkbox" id="publish1" value="yes" name="wpsb_fpublishBtn" <?php if(get_option('wpsb_fpublishBtn')=='yes'){echo 'checked="checked"';}?>/> Facebook&nbsp;<input type="checkbox" id="publish2" name="wpsb_tpublishBtn" value="yes" <?php if(get_option('wpsb_tpublishBtn')=='yes'){echo 'checked="checked"';}?>/> Twitter&nbsp;<input type="checkbox" id="publish3" name="wpsb_gpublishBtn" value="yes" <?php if(get_option('wpsb_gpublishBtn')=='yes'){echo 'checked="checked"';}?>/> Google Plus&nbsp;<input type="checkbox" id="publish4" name="wpsb_lpublishBtn" value="yes" <?php if(get_option('wpsb_lpublishBtn')=='yes'){echo 'checked="checked"';}?>/>Linkdin&nbsp;<input type="checkbox" id="publish6" name="wpsb_ppublishBtn" value="yes" <?php if(get_option('wpsb_ppublishBtn')=='yes'){echo 'checked="checked"';}?>/> Pinterest</p>
   ...
   <p><label><strong><?php _e('Top Margin:');?></strong></label>&nbsp;<input type="text" id="wpsb_top_margin" name="wpsb_top_margin" value="<?php echo get_option('wpsb_top_margin'); ?>" placeholder="10% OR 10px" size="15"/></p>
	...
	<p><strong>Plugin Author:</strong><br><img src="<?php echo  plugins_url( 'images/raghu.jpg' , __FILE__ );?>" width="75" height="75" class="authorimg"><br><a href="http://raghunathgurjar.wordpress.com" target="_blank">Raghunath Gurjar</a></p>
	...
	<ul>
		...
		<li><a href="https://wordpress.org/plugins/wc-sales-count-manager/" target="_blank">WC Sales Count Manager</a></li>
		</ul></p></td>
	</tr>
	</table>
	</div>
...
<li>Option for set floating sidebar position to horizontal automaticaly for mobile users</li>
...
<p><a target="_blank" href="http://extensions.mrwebsolution.in/wp-social-buttons-pro" class="pagelink">GO Pro</a> OR
<a target="_blank" href="http://extensions.mrwebsolution.in/wp-social-buttons-pro" class="pagelink">Live Demo</a>
</p>
