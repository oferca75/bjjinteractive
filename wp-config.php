<?php
if ($_SERVER["SERVER_NAME"] == "bjj.totalh.net" || $_SERVER["SERVER_NAME"] == "livebjj.ga"){
Header( "HTTP/1.1 301 Moved Permanently" ); 
Header( "Location: http://bjjinteractive.ga" ); 
 exit;
};
/**
...
define( 'WPCACHEHOME', '/home/vol4_2/byethost10.com/b10_17760370/bjj.totalh.net/htdocs/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
